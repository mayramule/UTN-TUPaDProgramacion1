...
mis_gustos = ["Aceitunas", "Pizza", "Café", "Rosas", "Gatos"]
print("El penúltimo elemento es de mis gustos es :", mis_gustos[-2])
...
'''5) El programa elimina el número más grande de la lista y luego imprime los restantes. '''

'''6) Crear una lista con números del 10 al 30 (incluído), haciendo saltos de 5 en 5 y mostrar por
pantalla los dos primeros.'''
numeros = list(range(10,31,5))
print(f"Los numeros de la lista son: {numeros}")
print(f"Los dos prmeros numeros son: {numeros[0]}, {numeros[1]}")
